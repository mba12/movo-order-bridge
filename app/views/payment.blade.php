    ...
    <div class="fields">
        <div class="row single">
            <div class="field">
                ...
                <input type="text" @if(App::environment()=='local'
                                        || App::environment()=='devorders'
                                        || App::environment()=='qaorders'
                                      )
                    {{'value="4242424242424242"'}}  @endif data-stripe="number" placeholder="Credit Card Number" id="credit-card-number" maxlength="16" data-validate="min:15|max:16|number" data-error-selector=".error-messages .credit-card"/>
            </div>
        </div>
